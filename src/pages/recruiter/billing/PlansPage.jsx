    ...
    <div className="p-6 max-w-4xl mx-auto space-y-12 text-text-primary font-sans bg-primary min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="bg-secondary border border-border-default rounded-xl p-6 relative flex flex-col">
          <h2 className="text-text-primary text-xl font-bold">Free</h2>
          <div className="mt-2">
            <span className="text-text-primary text-3xl font-mono font-bold">$0</span>
            <span className="text-text-secondary text-sm"> / month</span>
          </div>
          <p className="text-text-tertiary text-sm mt-1 mb-4">50 assessments / month</p>
          ...
          <div className="mt-auto pt-4">
            {tier === "free" ? (
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-lg border border-accent text-accent hover:bg-accent-soft text-sm font-semibold transition-smooth cursor-pointer text-center"
              >
                Get Started Free
              </button>
            )}
        ...
        <div className="bg-secondary border border-accent rounded-xl p-6 relative flex flex-col shadow-lg shadow-accent-soft/10">
          ...
          <h2 className="text-text-primary text-xl font-bold">Pro</h2>
          <div className="mt-2">
            <span className="text-text-primary text-3xl font-mono font-bold">$49</span>
            <span className="text-text-secondary text-sm"> / month</span>
          </div>
          ...
          <div className="mt-auto pt-4 space-y-2">
            {tier === "pro" ? (
              ...
              <div className="flex flex-col gap-2">
                <button
                  disabled
                  className="w-full py-2.5 px-4 rounded-lg bg-accent text-text-primary opacity-50 cursor-not-allowed text-sm font-semibold text-center flex items-center justify-center gap-1.5"
                >
                  <span>Upgrade to Pro</span>
                  <span className="bg-tertiary text-text-tertiary text-[10px] px-1.5 py-0.5 rounded-full select-none">
                    Coming Soon
                  </span>
                </button>
              </div>
        ...
        {/* Enterprise Plan */}
        <div className="bg-secondary border border-border-default rounded-xl p-6 relative flex flex-col">
          <h2 className="text-text-primary text-xl font-bold">Enterprise</h2>
          <div className="mt-2">
            <span className="text-text-primary text-2xl font-sans font-bold">Custom pricing</span>
          </div>
          <p className="text-text-tertiary text-sm mt-2 mb-4">Unlimited assessments</p>
          ...
          <div className="mt-auto pt-4">
            {tier === "enterprise" ? (
              ...
              <a
                href="mailto:sales@skillgate.app"
                className="w-full inline-flex items-center justify-center py-2.5 px-4 rounded-lg border border-accent text-accent hover:bg-accent-soft text-sm font-semibold transition-smooth text-center cursor-pointer"
              >
                Contact Sales
              </a>
            )}
          ...
          <table className="w-full text-left text-sm border-collapse">
            <thead>
              <tr className="bg-tertiary text-text-secondary text-xs uppercase font-semibold border-b border-border-default">
                ...
                <th className="px-4 py-3 text-center w-28">Free</th>
                <th className="px-4 py-3 text-center w-28">Pro</th>
                <th className="px-4 py-3 text-center w-28">Enterprise</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border-default">
              {[
                ...
                { name: "Monthly Assessments", free: "50", pro: "500", ent: "Unlimited" },
